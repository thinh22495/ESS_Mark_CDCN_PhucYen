...
Public Class rptMARK_BangDiemTongKetHocPhan_HVCS
    ...
    Public Sub binding()
        ...
        Me.CC.DataBindings.Add("Text", DataSource, "DiemCC")
        Me.KT1.DataBindings.Add("Text", DataSource, "KT1")
        Me.KT2.DataBindings.Add("Text", DataSource, "KT2")
        Me.KT3.DataBindings.Add("Text", DataSource, "KT3")
        Me.KT4.DataBindings.Add("Text", DataSource, "KT4")
