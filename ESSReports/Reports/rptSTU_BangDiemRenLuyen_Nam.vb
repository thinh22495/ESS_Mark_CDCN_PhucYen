...
Public Class rptSTU_BangDiemRenLuyen_Nam
    ...
    Public Sub binding()
        ...
        Me.Tong_diem_ky1.DataBindings.Add("Text", DataSource, "Tong_diem_ky1")
        Me.Tong_diem_ky2.DataBindings.Add("Text", DataSource, "Tong_diem_ky2")
