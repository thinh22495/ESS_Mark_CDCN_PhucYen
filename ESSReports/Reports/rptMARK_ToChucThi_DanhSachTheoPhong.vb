...
Public Class rptMARK_ToChucThi_DanhSachTheoPhong
    ...
    Public Sub binding()
        ...
        'Me.Ma_nganh.DataBindings.Add("Text", DataSource, "Ma_nganh")
        Me.SBD.DataBindings.Add("Text", DataSource, "So_bao_danh")
