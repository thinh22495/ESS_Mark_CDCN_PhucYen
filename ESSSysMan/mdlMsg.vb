Module mdlMsg
    ...
    Public Const msgERRO As String = "Hãy liên lạc với người quản trị để được trợ giúp"
    ...
    Public Function Thongbao(ByVal strMSG As String, Optional ByVal Button As MsgBoxStyle = MsgBoxStyle.Information, Optional ByVal Title As String = "Thông báo", Optional ByVal Align As ContentAlignment = ContentAlignment.MiddleCenter) As MsgBoxResult
        Dim frmESS_MSG As New frmESS_MsgBox
        Dim Result1, Result2, Result3 As MsgBoxResult
        'Dim Thongbao_icon
        'Dim ClickButton
        Dim leftBtn As Double
        frmESS_MSG.lblMSG.Text = strMSG
        ...
        Select Case frmESS_MSG.Tag.ToString
            Case 1
                Thongbao = Result1
            Case 2
                Thongbao = Result2
