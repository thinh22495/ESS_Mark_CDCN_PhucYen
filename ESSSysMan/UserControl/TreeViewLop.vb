...
'                'If dtLop.Rows(i)("ID_he").ToString = mID_he And dtLop.Rows(i)("ID_khoa").ToString = mID_khoa Then
'                If dtLop.Rows(i)("ID_he").ToString = mID_he Then
...
'            Next
'            Dim objLop As New Lop_Bussines(dsID_lop, -1, -1, -1)
