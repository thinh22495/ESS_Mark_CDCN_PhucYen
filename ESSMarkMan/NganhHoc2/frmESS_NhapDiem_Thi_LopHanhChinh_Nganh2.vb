...
Public Class frmESS_NhapDiem_Thi_LopHanhChinh_Nganh2
...
#End Region
    ...
    Private Sub cmdPrintBienBanThi_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Try
            If Not grdViewDiem.DataSource Is Nothing Then
                ...
                If TreeViewChuyenNganh_Nganh21.ID_chuyen_nganh > 0 Then 'La Lop
                    Tieu_de1 = "BIÊN BẢN THI LẦN: " + cmbLan_thi.Text
    ...
    '            Dim mNien_khoa As String = TreeViewChuyenNganh_Nganh21.Nien_khoa
