...
Imports ESSUtility
Imports ESSReports
Public Class frmESS_NhapDiem_ThanhPhan_LopHanhChinh_Nganh2
    Private mID_dt As String = 0
        ...
        Try
            If Loader Then
                If TreeViewChuyenNganh_Nganh21.ID_chuyen_nganh > 0 Then
                    mNien_khoa = TreeViewChuyenNganh_Nganh21.Nien_khoa
                    mID_dt = TreeViewChuyenNganh_Nganh21.ID_dt
                    If mID_dt > 0 Then
                        clsCTDT = New ChuongTrinhDaoTao_Bussines(mID_dt, gobjUser.ID_Bomon)
                        Add_MonHoc()
                    End If
        ...
        Try
            If Loader Then
                ...
                If mdtDanhSachSinhVien.Rows.Count > 0 And ID_mon > 0 Then
                    ...
                    clsDiem = New Diem_Bussines(Hoc_ky, Nam_hoc, ID_mon, mID_dt, mdtDanhSachSinhVien)
...
#End Region
    ...
    Private Sub cmdLocked_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Try
    ...
    Private Sub cmdPrint_Diem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Try
            If Not grdViewDiem.DataSource Is Nothing Then
                ...
                Tieu_de2 = "HỌC PHẦN: " + cmbID_mon.Text.ToUpper
        ...
        Try
            ...
            If dt_Main.Rows.Count > 0 Then
                ...
                For i As Integer = 0 To dt_Main.Rows.Count - 1
                    ...
                    dt_Main.Rows(i).Item("Tieu_de2") = "HỌC PHẦN: " & cmbID_mon.Text.ToUpper
                Next
        ...
        Try
            If Not grdViewDiem.DataSource Is Nothing Then
                ...
                For i As Integer = 0 To dtDiemTH.Rows.Count - 1
                    dtDiemTH.Rows(i)("Khoa_hoc") = TreeViewChuyenNganh_Nganh21.Khoa_hoc.ToString
        ...
        Try
            If Not grdViewDiem.DataSource Is Nothing Then
                ...
                If dtDiemTH.Rows.Count > 0 Then
                    Tieu_de2 = "Học kỳ: " & cmbHoc_ky_TP.Text & " Năm học: " & cmbNam_hoc_TP.Text & " Học phần: " & cmbID_mon.Text & "  Giảng viên: .......................... Khoa:............................."
    ...
    '        Me.Cursor = Cursors.WaitCursor
    '        Dim dv As DataView = grdViewDiem.DataSource
    '        If TreeViewChuyenNganh_Nganh21.ID_chuyen_nganh > 0 AndAlso TreeViewChuyenNganh_Nganh21.ID_dt > 0 Then
    ...
    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdKhoa_Diem.Click
