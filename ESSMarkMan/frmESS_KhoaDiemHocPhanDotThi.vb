...
Imports ESS.Objects
Public Class frmESS_KhoaDiemHocPhanDotThi
    ...
    Private Sub frmESS_KhoaDiemHocPhanDotThi_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
    ...
    Private Sub frmESS_KhoaDiemHocPhanDotThi_Paint(ByVal sender As Object, ByVal e As System.Windows.Forms.PaintEventArgs) Handles Me.Paint
...
#End Region
    ...
    Private Sub cmdLock_Click_1(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdLock.Click
        ...
        Try
            ...
            For i As Integer = 0 To dtDiem.Rows.Count - 1
                clsDiem.Lock_UnLock_Diem(dtDiem.Rows(i)("ID_sv"), mID_mon, mLan_thi, 1)
            Next
    ...
    Private Sub cmdUnLock_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdUnLock.Click
        ...
        Try
            ...
            Dim dtDiem As DataTable = grdViewDiem.DataSource.Table
            For i As Integer = 0 To dtDiem.Rows.Count - 1
                clsDiem.Lock_UnLock_Diem(dtDiem.Rows(i)("ID_sv"), mID_mon, mLan_thi, 0)
            Next
            'Load lại dữ liệu điểm
            Call trvPhongThi_Select()
