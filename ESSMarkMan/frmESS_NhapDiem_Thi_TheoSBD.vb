...
Public Class frmESS_NhapDiem_Thi_TheoSBD
                ...
                If mID_thi > 0 Then
                    ...
                    If dtDanhSachSinhVien.Rows.Count > 0 Then
                        ...
                        If mID_phong_thi > 0 Then
                            clsDiem = New Diem_Bussines(ID_dv, mHoc_ky, mNam_hoc, mID_mon, dsID_lop, dtDanhSachSinhVien, True)
                        Else
                            clsDiem = New Diem_Bussines(ID_dv, mHoc_ky, mNam_hoc, mID_mon, dsID_lop, dtDanhSachSinhVien, False)
                        End If
...
#End Region
    ...
    Private Sub KếtQuảThiCácPhòngToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Try
