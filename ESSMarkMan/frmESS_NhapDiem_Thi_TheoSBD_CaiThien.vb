...
Public Class frmESS_NhapDiem_Thi_TheoSBD_CaiThien
    ...
    Private Sub FormatDataView(ByVal dtDiemChu As DataTable, ByVal dtKyHieuDiem As DataTable)
        Try
            ...
            With col6
                ...
                .HeaderText = "Y (" + (100 - Tong_ty_le).ToString + ")"
                .Width = 60
...
#Region "Control Events"
    Private Sub cmdSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSave.Click
        Try
            ...
            'Lưu điểm thi
            clsDiem.LuuDiemThi_CaiThien(mLan_thi, dv)
        ...
        Try
            If Loader Then
                ...
                If mID_thi > 0 Then
                    ...
                    clsTCThi = New TochucThi_Bussines(mID_thi, True)
                    ...
                    If dtDanhSachSinhVien.Rows.Count > 0 Then
                        ...
                        If mID_phong_thi > 0 Then
                            clsDiem = New Diem_Bussines(ID_dv, 0, "", mID_mon, dsID_lop, dtDanhSachSinhVien, True, , , , , True)
                        Else
                            clsDiem = New Diem_Bussines(ID_dv, 0, "", mID_mon, dsID_lop, dtDanhSachSinhVien, False, , , , , True)
                        End If
                        ...
                        dv = clsDiem.DanhSachDiemThiCaiThien(mID_mon).DefaultView
...
#End Region
    ...
    Private Sub cmdPrint_sochu_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdPrint_sochu.Click
        Me.Cursor = Cursors.WaitCursor
        Try
    ...
    Private Sub cmdPrint_tinchi_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdPrint_tinchi.Click
        Me.Cursor = Cursors.WaitCursor
        Try
            If Not grdViewDiem.DataSource Is Nothing Then
                Dim dt_ngay As DataTable = clsTCThi.DanhSachMonToChucThi()
    ...
    Private Sub cmdKyHieuDiem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdKyHieuDiem.Click
        Dim frmESS_ As New frmESS_DMDiemKyHieu
        frmESS_.ShowDialog()
    End Sub

    Private Sub chkNot_show_all_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles chkNot_show_all.CheckedChanged
    ...
    Private Sub frmESS_NhapDiemThiSBD_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
    ...
    Private Sub KếtQuảThiCácPhòngToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles KếtQuảThiCácPhòngToolStripMenuItem.Click
        Try
            If mID_thi <= 0 Or mLan_thi <= 0 Then Exit Sub
            Me.Cursor = Cursors.WaitCursor
            Dim dt As DataTable = clsTCThi.HienThi_ESSDanhsachThi_DiemThi(mID_thi, mLan_thi)
            If dt.Rows.Count > 0 Then
                dt.Columns.Add("Tieu_de_ten_bo")
                dt.Columns.Add("Tieu_de_Ten_truong")
                dt.Columns.Add("Tieu_de")
                Dim frmESS_ As New frmESS_XemBaoCao
                frmESS_.ShowDialog("BangDiemThi_DotThi", dt)
            End If
        Catch ex As Exception
            Thongbao(ex.Message)
        End Try
