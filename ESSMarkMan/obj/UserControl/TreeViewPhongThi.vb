...
PhongThi:
                                ...
                                trvThi.Nodes(i).Nodes(j).Nodes(k).Nodes(l).Nodes(m).Nodes(n).Tag = dr.Item("ID_khoa").ToString + "#" + dr.Item("ID_thi").ToString + "#" + dr.Item("ID_mon").ToString + "#" + dr.Item("Lan_thi").ToString + "#" + dr.Item("ID_phong_thi").ToString
