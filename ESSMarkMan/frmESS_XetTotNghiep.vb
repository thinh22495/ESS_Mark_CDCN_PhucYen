...
#Region "Form Events"
    Private Sub frmESS_XetTotNghiep_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Me.trvLop2.HienThi_ESSTreeView()
...
#Region "Control Events"
    Private Sub trvLop1_Select() Handles trvLop1.TreeNodeSelected_
        Try
            If Not trvLop1.ID_lop_list Is Nothing Then
                dsID_lop_TN = trvLop1.ID_lop_list
                'Load danh sách sinh viên
                Dim objDanhSach As New DanhSachSinhVien_Bussines(dsID_lop_TN)
                ...
                Else
                    mID_dt = 0
                End If
                clsDSXetTN = New DanhSachTotNghiep_Bussines(gobjUser.ID_dv, dsID_lop_TN, mdtDanhSachSinhVien_TN, 1, mID_dt, False)
    ...
    Private Sub trvLop2_Select() Handles trvLop2.TreeNodeSelected_
        Try
            If Not trvLop2.ID_lop_list Is Nothing Then
                dsID_lop_ChuaTN = trvLop2.ID_lop_list
                'Load danh sách sinh viên
                Dim objDanhSach As New DanhSachSinhVien_Bussines(dsID_lop_ChuaTN)
                mdtDanhSachSinhVien_ChuaTN = objDanhSach.Danh_sach_sinh_vien
                If trvLop2.ID_chuyen_nganh > 0 Then
                    mID_dt = trvLop2.ID_dt_list
                Else
                    mID_dt = 0
                End If

                clsDSXetTN = New DanhSachTotNghiep_Bussines(gobjUser.ID_dv, dsID_lop_ChuaTN, mdtDanhSachSinhVien_ChuaTN, 0, mID_dt, False)
                If cmbNam_hoc.Text.Trim <> "" Then
...
#End Region
    ...
    Private Sub cmdPrint_DS_nototnghiep_ItemClick(ByVal sender As Object, ByVal e As DevExpress.XtraBars.ItemClickEventArgs) Handles cmdPrint_DS_nototnghiep.ItemClick
        Try
            ...
            If dv.Count > 0 Then
                ...
                If trvLop2.Tieu_de_Lop <> "" Then 'La Lop
                    Tieu_de = trvLop2.Tieu_de_Lop.ToUpper
                Else
                    Tieu_de = trvLop2.Tieu_de
                End If
    ...
    Private Sub cmdPrint_BD_toankhoa_ItemClick(ByVal sender As Object, ByVal e As DevExpress.XtraBars.ItemClickEventArgs) Handles cmdPrint_BD_toankhoa.ItemClick
        Try
            ...
            If dv.Count > 0 Then
                ...
                clsDiem = New Diem_Bussines(gobjUser.ID_dv, gobjUser.ID_Bomon, 0, "", dsID_lop_TN, mID_dt, mdtDanhSachSinhVien_TN)
                ...
                For i As Integer = 0 To dt.Rows.Count - 1
                    ...
                    If grvTotNghiep.GetFocusedDataRow()("Ngay_QD").ToString.Trim <> "" Then
                        dt.Rows(i).Item("Nien_khoa") = Year(grvTotNghiep.GetFocusedDataRow()("Ngay_QD")) 'cmbNam_hoc.Text  'grvTotNghiep.GetFocusedDataRow()("Nien_khoa").ToString
                    End If
    ...
    Private Sub cmdXetTN_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdXetTN.Click
        If cmbNam_hoc.Text.Trim <> "" And cmbLan_thu.Text.Trim <> "" Then
            ...
            clsDSXetTN = New DanhSachTotNghiep_Bussines(gobjUser.ID_dv, dsID_lop_TN, mdtDanhSachSinhVien_TN, 1, mID_dt, False)
            clsDSXetTN.XetTotNghiep(cmbNam_hoc.Text, cmbLan_thu.Text, gobjUser.ID_Bomon)
    ...
    Private Sub cmdPrint_DS_totnghiep_ItemClick(ByVal sender As System.Object, ByVal e As DevExpress.XtraBars.ItemClickEventArgs) Handles cmdPrint_DS_totnghiep.ItemClick
        ...
        Try
            ...
            Tieu_de1 = "DANH SÁCH TỐT NGHIỆP HỆ " & trvLop1.Ten_he.ToUpper
            If trvLop1.Khoa_hoc Then
                Tieu_de1 = Tieu_de1 + " KHÓA: " & trvLop1.Khoa_hoc
            End If
            If trvLop1.Ten_lop <> "" Then
                Tieu_de1 = Tieu_de1 + "  LỚP: " & trvLop1.Ten_lop.ToUpper
            End If
    ...
    Private Sub BarButtonItem2_ItemClick(ByVal sender As System.Object, ByVal e As DevExpress.XtraBars.ItemClickEventArgs) Handles BarButtonItem2.ItemClick
        ...
        dv.RowFilter = "Chon='True'"
        If dv.Count = 0 Then Exit Sub
        Dim rpt As New rptBangTotNghiep(dv)
        PrintXtraReport(rpt)
    End Sub
    ...
    Private Sub cmdTongHop_XetTN_ItemClick(ByVal sender As System.Object, ByVal e As DevExpress.XtraBars.ItemClickEventArgs) Handles cmdTongHop_XetTN.ItemClick
        clsDSXetTN = New DanhSachTotNghiep_Bussines
