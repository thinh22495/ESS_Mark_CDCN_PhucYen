...
Public Class frmESS_NhapDiem_Thi_TuiThi
...
#Region "Form Events"
    Private Sub frmESS_NhapDiemTuiThi_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
        ...
        End Try
    End Sub
    Private Sub frmESS_NhapDiemTuiThi_Paint(ByVal sender As Object, ByVal e As System.Windows.Forms.PaintEventArgs) Handles Me.Paint
        ...
        Try
            If Loader Then
                ...
                If mID_thi > 0 Then
                    ...
                    If mTui_so > 0 Then   'Load sinh viên theo từng tui thi
                        dtDanhSachSinhVien = clsTCThi.DanhSachSinhVienTheoTuiThi(mID_thi, mTui_so)
                    Else    'Load tất cả sinh viên của tổ chức thi
                        dtDanhSachSinhVien = clsTCThi.DanhSachSinhVienTheoTuiThi(mID_thi, -1)
                    End If
...
#End Region
    ...
    Private Sub cmdPrint_sochu_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Try
            If Not grdViewDiem.DataSource Is Nothing Then
                ...
                Tieu_de3 = "Túi số: " & mTui_so & vbTab & "Ngày thi: " & Format(CType(mNgay_thi, Date), "dd/MM/yyyy")
    ...
    Private Sub frmESS_NhapDiemTuiThi_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
