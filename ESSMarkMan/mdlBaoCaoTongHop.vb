...
Module mdlBaoCaoTongHop
    ...
    Public Sub TaoBaoCaoTongHopDiem(ByVal c1r As C1Report, ByVal mPaperSize As Printing.PaperKind, ByVal mOrientation As C1.Win.C1Report.OrientationEnum, ByVal Tieu_de1 As String, ByVal Tieu_de2 As String, ByVal Tieu_de_hoc_trinh As String, ByVal dtMonHoc As DataTable)
        ...
        If objBaoCaoTieuDe.Count > 0 Then
            ...
            objBaocao.Tieu_de_chuc_danh3 = objBaoCaoTieuDe.ESSBaoCaoTieuDe(0).Tieu_de_chuc_danh3
            objBaocao.Tieu_de_chuc_danh4 = objBaoCaoTieuDe.ESSBaoCaoTieuDe(0).Tieu_de_chuc_danh4
            ...
            objBaocao.Tieu_de_nguoi_ky3 = objBaoCaoTieuDe.ESSBaoCaoTieuDe(0).Tieu_de_nguoi_ky3
            objBaocao.Tieu_de_nguoi_ky4 = objBaoCaoTieuDe.ESSBaoCaoTieuDe(0).Tieu_de_nguoi_ky4
        ...
        Else
            ...
            objBaocao.Tieu_de_chuc_danh3 = ""
            objBaocao.Tieu_de_chuc_danh4 = ""
            objBaocao.Tieu_de_nguoi_ky1 = ""
            objBaocao.Tieu_de_nguoi_ky2 = ""
            objBaocao.Tieu_de_nguoi_ky3 = ""
            objBaocao.Tieu_de_nguoi_ky4 = ""
        ...
        objBaoCaoChiTiet.FieldName = "Mã SV"
        ...
        objBaoCaoChiTiet.FieldName = "Lớp"
        objBaoCaoChiTiet.FieldType = 1
        ...
        objBaoCaoChiTiet.FieldAlign = 1.5
        objBaoCaoChiTiet.FieldObject = 1
        objBaocao.BaoCaoChiTiet.Add(objBaoCaoChiTiet)

        objBaoCaoChiTiet = New ESSBaoCaoChiTietTruong
        objBaoCaoChiTiet.STT = 5
        objBaoCaoChiTiet.FieldID = "TBCHT10"
        objBaoCaoChiTiet.FieldName = "TBCHT TĐ10"
        objBaoCaoChiTiet.FieldType = 1
        objBaoCaoChiTiet.FieldSize = 1.3
        objBaoCaoChiTiet.FieldAlign = 1.5
        objBaoCaoChiTiet.FieldObject = 1
        ...
        objBaoCaoChiTiet.FieldType = 1
        objBaoCaoChiTiet.FieldSize = 0.5
        objBaoCaoChiTiet.FieldAlign = 2
        objBaoCaoChiTiet.FieldObject = 1
        objBaocao.BaoCaoChiTiet.Add(objBaoCaoChiTiet)
        'Thiết lập các trường Học phần báo cáo
        Dim sGhi_chu As String = ""
        If dtMonHoc.Rows.Count > 0 Then
            'Tính độ rộng của cột điểm Học phần
            FieldWidth = (PageWidth - (2 + 4 + 1 + 1.5 + 2.2 + 1.5 + 2.5) * gDonvi_do) / dtMonHoc.Rows.Count
            'Add các cột điểm
            sGhi_chu = "GHI CHÚ THÔNG TIN Học phần: " & vbCrLf & vbCrLf
            For i As Integer = 0 To dtMonHoc.Rows.Count - 1
                ...
                sGhi_chu += "     " & dtMonHoc.Rows(i)("Ky_hieu") & " - " & dtMonHoc.Rows(i)("Ten_mon") & vbCrLf
                objBaoCaoChiTiet.FieldType = 1
            ...
            Next
        End If
        objBaocao.TaoBaoCaoTongHopDiem(sGhi_chu)
    End Sub
    ...
    Public Sub TaoBaoCaoBangDiemThanhPhan(ByVal c1r As C1Report, ByVal mPaperSize As Printing.PaperKind, ByVal mOrientation As C1.Win.C1Report.OrientationEnum, ByVal Tieu_de1 As String, ByVal Tieu_de2 As String, ByVal Tieu_de3 As String, ByVal dtTP As DataTable)
        ...
        objBaoCaoChiTiet = New ESSBaoCaoChiTietTruong
        objBaoCaoChiTiet.STT = 4
        objBaoCaoChiTiet.FieldID = "Ten_khoa"
        objBaoCaoChiTiet.FieldName = "Khoa"
        objBaoCaoChiTiet.FieldType = 1
        ...
        If dtTP.Rows.Count > 0 Then
            ...
            FieldWidth = (PageWidth - (1 + 2 + 4 + 3 + 2 + 2 + 2.5) * gDonvi_do) / dtTP.Rows.Count
        ...
        objBaoCaoChiTiet = New ESSBaoCaoChiTietTruong
        objBaoCaoChiTiet.STT = 9
        objBaoCaoChiTiet.FieldID = ""
    ...
    Public Sub TaoBaoCaoBangDiemThiHocPhan_DSLop_HC(ByVal c1r As C1Report, ByVal mPaperSize As Printing.PaperKind, ByVal mOrientation As C1.Win.C1Report.OrientationEnum, ByVal Tieu_de1 As String, ByVal Tieu_de2 As String, ByVal Tieu_de3 As String, ByVal dtTP As DataTable, ByVal XS As Integer, ByVal Gioi As Integer, ByVal Kha As Integer, ByVal TB As Integer, ByVal KDat As Integer)
        ...
        If objBaoCaoTieuDe.Count > 0 Then
            objBaocao.Tieu_de_ten_bo = objBaoCaoTieuDe.ESSBaoCaoTieuDe(0).Tieu_de_Ten_truong.ToUpper
            objBaocao.Tieu_de_ten_truong = "KHOA, BỘ MÔN: ........................"
            objBaocao.Tieu_de_chuc_danh1 = objBaoCaoTieuDe.ESSBaoCaoTieuDe(0).Tieu_de_chuc_danh1.ToUpper
            objBaocao.Tieu_de_chuc_danh2 = objBaoCaoTieuDe.ESSBaoCaoTieuDe(0).Tieu_de_chuc_danh2.ToUpper
            objBaocao.Tieu_de_chuc_danh3 = objBaoCaoTieuDe.ESSBaoCaoTieuDe(0).Tieu_de_chuc_danh3.ToUpper
            objBaocao.Tieu_de_nguoi_ky1 = objBaoCaoTieuDe.ESSBaoCaoTieuDe(0).Tieu_de_nguoi_ky1.ToUpper
            objBaocao.Tieu_de_nguoi_ky2 = objBaoCaoTieuDe.ESSBaoCaoTieuDe(0).Tieu_de_nguoi_ky2.ToUpper
            objBaocao.Tieu_de_nguoi_ky3 = objBaoCaoTieuDe.ESSBaoCaoTieuDe(0).Tieu_de_nguoi_ky3.ToUpper
            objBaocao.Tieu_de_noi_ky = objBaoCaoTieuDe.ESSBaoCaoTieuDe(0).Tieu_de_noi_ky
        Else
            objBaocao.Tieu_de_ten_bo = ""
            objBaocao.Tieu_de_ten_truong = ""
        ...
        objBaoCaoChiTiet.FieldName = "Khoa"
        objBaoCaoChiTiet.FieldType = 1
        objBaoCaoChiTiet.FieldSize = 2.7
        objBaoCaoChiTiet.FieldAlign = 2
        objBaoCaoChiTiet.FieldObject = 1
        objBaocao.BaoCaoChiTiet.Add(objBaoCaoChiTiet)
        ...
        If dtTP.Rows.Count > 0 Then
            ...
            For i As Integer = 0 To dtTP.Rows.Count - 1
                ...
                objBaoCaoChiTiet.STT = i + 3
                objBaoCaoChiTiet.FieldID = dtTP.Rows(i)("Ky_hieu").ToString
                objBaoCaoChiTiet.FieldName = dtTP.Rows(i)("Ky_hieu") 'dtTP.Rows(i)("Ky_hieu").ToString
                objBaoCaoChiTiet.FieldType = 1
                objBaoCaoChiTiet.FieldSize = FieldWidth / (gDonvi_do * 2)
                objBaoCaoChiTiet.FieldAlign = 2
                objBaoCaoChiTiet.FieldObject = 1
                objBaoCaoChiTiet.ColFix = False
                objBaocao.BaoCaoChiTiet.Add(objBaoCaoChiTiet)
        ...
        objBaoCaoChiTiet.FieldName = "Ghi chú"
        objBaoCaoChiTiet.FieldType = 1
        objBaoCaoChiTiet.FieldSize = FieldWidth / gDonvi_do - 0.5
        objBaoCaoChiTiet.FieldAlign = 2
        objBaoCaoChiTiet.FieldObject = 1
        objBaocao.BaoCaoChiTiet.Add(objBaoCaoChiTiet)
    ...
    Public Sub TaoBaoCaoBangDiemThiHocPhan_DSLop_HC_DiemChu(ByVal c1r As C1Report, ByVal mPaperSize As Printing.PaperKind, ByVal mOrientation As C1.Win.C1Report.OrientationEnum, ByVal Tieu_de1 As String, ByVal Tieu_de2 As String, ByVal Tieu_de3 As String, ByVal dtTP As DataTable, ByVal XS As Integer, ByVal Gioi As Integer, ByVal Kha As Integer, ByVal TB As Integer, ByVal KDat As Integer)
        ...
        If dtTP.Rows.Count > 0 Then
            ...
            For i As Integer = 0 To dtTP.Rows.Count - 1
                ...
                objBaoCaoChiTiet.STT = i + 3
                objBaoCaoChiTiet.FieldID = dtTP.Rows(i)("Ky_hieu").ToString
                objBaoCaoChiTiet.FieldName = dtTP.Rows(i)("Ky_hieu").ToString  'dtTP.Rows(i)("Ten_thanh_phan")
                objBaoCaoChiTiet.FieldType = 1
                objBaoCaoChiTiet.FieldSize = FieldWidth / (gDonvi_do * 2)
                objBaoCaoChiTiet.FieldAlign = 2
                objBaoCaoChiTiet.FieldObject = 1
