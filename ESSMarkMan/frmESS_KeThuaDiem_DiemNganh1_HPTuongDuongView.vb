...
Imports ESS.Objects
Imports ESSUtility
Public Class frmESS_KeThuaDiem_DiemNganh1_HPTuongDuongView
...
#Region "Form Events"
    Public Overloads Sub ShowDialog(ByVal ID_dt1 As Integer, ByVal ID_dt2 As Integer, ByVal ID_sv As Integer)
        Try
            ...
            mID_dt2 = ID_dt2
            mID_dt1 = ID_dt1
            mclsHocNganh2 = New DanhSachNganh2_Bussines(gobjUser.ID_dv, mID_sv, mID_dt2, 1)
            Dim dt As DataTable = mclsHocNganh2.DanhSachMonSinhVienNganh1_TuongDuong_Nganh2_ChuaChon
            Dim dt_dacapnhat As DataTable = mclsHocNganh2.DanhSachMonSinhVienNganh1_TuongDuong_Nganh2DaChon()
    ...
    Private Sub frmESS_KeThuaDiem_DiemNganh1_HPTuongDuongView_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
        Catch ex As Exception
            Thongbao(ex.Message)
        End Try
    ...
    Private Sub frmESS_KeThuaDiem_DiemNganh1_HPTuongDuongView_Paint(ByVal sender As Object, ByVal e As System.Windows.Forms.PaintEventArgs) Handles Me.Paint
        ...
        Try
            ...
            For i As Integer = 0 To dv.Count - 1
                ...
                If dv.Item(i)("Chon") Then
                    ...
                    mclsDiem.KeThuaDiemNganh1ChoNganh2_MonTuongDuong(dv.Item(i)("ID_mon"), mID_sv, ID_diem)
                End If
            Next
