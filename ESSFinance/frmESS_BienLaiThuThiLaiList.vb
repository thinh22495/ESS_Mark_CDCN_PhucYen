...
Imports ESS.Objects
Public Class frmESS_BienLaiThuThiLaiList
...
#Region "Functions And Subs"
    ...
    Private Sub Fillter_BienLai()
        If Loader Then
            ...
            If dtpTu_ngay.Checked Then strFillter += " AND Ngay_thu>='" + dtpTu_ngay.Value.ToShortDateString + "'"
            If dtpDen_ngay.Checked Then strFillter += " AND Ngay_thu<='" + dtpDen_ngay.Value.ToShortDateString + "'"
            If chkPhieu_huy.Checked Then strFillter += " AND Huy_phieu=1"
            ...
            'Tính tổng số tiền
            Dim So_tien_VND, So_tien_USD As Integer
...
#Region "Form Events"
    Private Sub frmESS_BienLaiThuList_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        cmbID_thu_chi.SelectedValue = 18
    ...
    Private Sub cmdAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdAdd.Click
        Try
            If trvLop.ID_he > 0 Then
                Dim frmESS_ As New frmESS_BienLaiThuThiLai
                frmESS_.ShowDialog(-1, clsBL, trvLop.ID_he, trvLop.ID_lop_list, cmbHoc_ky.SelectedValue, cmbNam_hoc.Text, cmbDot_thu.SelectedIndex + 1, cmbLan_thu.SelectedIndex + 1, cmbID_thu_chi.SelectedValue)
            Else
    ...
    Private Sub cmdXemBienLai_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdXemBienLai.Click
        ...
        If Not grdViewBienLai.CurrentRow Is Nothing Then
            ...
            If objBL.Thu_chi = True Then
                Dim frmESS_ As New frmESS_BienLaiThuThiLaiXem
