    ...
    Private Sub trvLop_AfterSelect(ByVal sender As System.Object, ByVal e As System.Windows.Forms.TreeViewEventArgs) Handles trvPhongThi.AfterSelect
        ...
        If e.Node.Tag <> "" Then
            ...
            If Arr.Length = 3 Then
                ...
                mLan_thi = Arr(2)
                mID_phong_thi = 0
                mKhoa_hoc = e.Node.Parent.Parent.Parent.Text
            ...
            ElseIf Arr.Length = 4 Then
                ...
                mLan_thi = Arr(2)
                mID_phong_thi = Arr(3)
                mKhoa_hoc = e.Node.Parent.Parent.Parent.Parent.Text
...
#Region "Control Events"
    ...
    Private Sub cmbHocky_Namhoc_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmbHoc_ky.SelectedIndexChanged, cmbNam_hoc.SelectedIndexChanged
        If Loader Then
            ...
            If Hoc_ky > 0 And Nam_hoc <> "" Then
                Dim clsThi As New TochucThi_Bussines(Hoc_ky, Nam_hoc, gobjUser.ID_Bomon)
    ...
    Private Sub TreeView_Lop(ByVal trvThi As TreeView, ByVal dtThi As DataTable, Optional ByVal SelectAll As Boolean = False)
        ...
        Dim ID_he As Long = 0, Khoa_hoc As Long = 0, ID_Mon As Long = 0, Dot_thi As Byte = 0, Lan_thi As Byte = 0, Tui_thi As Byte = 0, ID_phong_thi As Integer = 0
...
PhongThi:
                                ...
                                trvThi.Nodes(i).Nodes(j).Nodes(k).Nodes(l).Nodes(m).Nodes(n).Tag = dr.Item("ID_thi").ToString + "#" + dr.Item("ID_mon").ToString + "#" + dr.Item("Lan_thi").ToString + "#" + dr.Item("ID_phong_thi").ToString
                            ...
                            Else
                                ...
                                trvThi.Nodes(i).Nodes(j).Nodes(k).Nodes(l).Nodes(m).Tag = dr.Item("ID_thi").ToString + "#" + dr.Item("ID_mon").ToString + "#" + dr.Item("Lan_thi").ToString
                    ...
                    Else
                        k += 1
                        trvThi.Nodes(i).Nodes(j).Nodes.Add("Học phần: " + dr.Item("Ten_mon").ToString)
                ...
                Else
                    j += 1
                    trvThi.Nodes(i).Nodes.Add("Khoá: " + dr.Item("Khoa_hoc").ToString)
...
#Region "Property"
    ...
    Public ReadOnly Property Phong_thi() As String
        ...
        End Get
    End Property
    Public ReadOnly Property Khoa_hoc() As String
        Get
            Return mKhoa_hoc
        End Get
    End Property
