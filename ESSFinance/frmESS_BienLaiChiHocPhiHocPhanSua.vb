...
Imports ESS.Objects
Public Class frmESS_BienLaiChiHocPhiHocPhanSua
...
#Region "Functions And Subs"
    Public Overloads Sub ShowDialog(ByVal idx_bl As Integer, ByVal Ma_sv As String, ByVal clsBL As BienLaiThu_Bussines, ByVal ID_he As Integer, ByVal Hoc_ky As Integer, ByVal Nam_hoc As String, ByVal Dot_chi As Integer, ByVal Lan_chi As Integer)
        midx_bl = idx_bl
        mclsBL = clsBL
        mID_he = ID_he
        mHoc_ky = Hoc_ky
...
#Region "Control"
    ...
    Private Sub cmdSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSave.Click
        If CheckValidate() Then
            ...
            ElseIf midx_bl = -1 Then   'Add New biên lai
                Dim objBL As New ESSBienLaiThu
