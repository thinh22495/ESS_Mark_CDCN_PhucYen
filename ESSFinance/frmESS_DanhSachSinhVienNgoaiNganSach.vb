...
Public Class frmESS_DanhSachSinhVienNgoaiNganSach
    Private dsID_lop As String = "0"
    Private mclsDSSV As DanhSachSinhVien_Bussines

#Region "Form Events"
    Private Sub frmESS_DanhSachSinhVienNgoaiNganSach_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.trvLop.HienThi_ESSTreeView()
        SetUpDataGridView(grdViewDanhSach)
        SetUpDataGridView(grdViewSinhVienDaChon)
        SetQuyenTruyCap(, btnAdd, , btnDel)
    End Sub

    Private Sub frmESS_DanhSachSinhVienNgoaiNganSach_Paint(ByVal sender As Object, ByVal e As System.Windows.Forms.PaintEventArgs) Handles Me.Paint
...
#Region "Control Events"
    ...
    Private Sub optAll1_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles optAll1.CheckedChanged
        Dim dvDanhSachSinhVien As DataView
        dvDanhSachSinhVien = grdViewSinhVienDaChon.DataSource
        If Not dvDanhSachSinhVien Is Nothing Then
            For i As Integer = 0 To dvDanhSachSinhVien.Count - 1
    ...
    Private Sub trvLop_Select() Handles trvLop.TreeNodeSelected_
        Try
            If Not trvLop.ID_lop_list Is Nothing Then
                ...
                grdViewSinhVienDaChon.DataSource = dt2.DefaultView
    ...
    Private Sub btnAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAdd.Click
        Try
            ...
            Dim dv2 As DataView = grdViewSinhVienDaChon.DataSource
    ...
    Private Sub btnDel_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDel.Click
        Try
            If grdViewSinhVienDaChon.CurrentRow Is Nothing Then Exit Sub
            Dim dv As DataView = grdViewDanhSach.DataSource
            Dim dv2 As DataView = grdViewSinhVienDaChon.DataSource
    ...
    Private Sub cmdExcel_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdExcel.Click
        ...
        Try
            If Not grdViewSinhVienDaChon.DataSource Is Nothing Then
                Dim clsExcel As New ExportCommon
                Dim Tieu_de As String = ""
                clsExcel.ExportFromDataGridViewToExcel(grdViewSinhVienDaChon)
            Else
    ...
    Private Sub cmdPrint_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdPrint.Click
        Me.Cursor = Cursors.WaitCursor
        Try
            Dim dv1 As DataView = grdViewSinhVienDaChon.DataSource
...
#End Region
    ...
    Private Sub btnLoc_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnLoc.Click
        Try
            ...
            If txtHo_ten.Text.Trim <> "" Or dtpNS.Checked Then
                dv.RowFilter = "Ho_ten like '%" & txtHo_ten.Text.Trim & "%' AND Ngoai_ngan_sach=0"
                If dtpNS.Checked Then dv.RowFilter = "Ho_ten like '%" & txtHo_ten.Text.Trim & "%' AND Ngoai_ngan_sach=0" & " AND Ngay_sinh='" & dtpNS.Value.Date.ToString & "'"
            Else
                dv.RowFilter = "Ngoai_ngan_sach=0"
            End If
