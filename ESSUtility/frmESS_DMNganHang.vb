...
Public Class frmESS_DMNganHang
    Dim add As Boolean = False
    Dim edit As Boolean = False
    Dim loaded As Boolean = False
#Region "Khai bao Bien & Hang"
    Private Const Header As String = "NGÂN HÀNG CHÍNH SÁCH"
    Private Const TableName As String = "STU_NganHang"
    Private Const FieldID As String = "ID_ngan_hang"
    Private Const FieldMa As String = "Ma_ngan_hang"
    Private Const FieldTen As String = "Ten_ngan_hang"
    Private Const FieldTenEn As String = "Dia_chi"
    Private Const HeadMa As String = "Mã ngân hàng"
    Private Const HeadTen As String = "Tên ngân hàng"
    Private Const HeadTenEn As String = "Địa chỉ"
...
#Region "User Functions"
    ...
    Private Function CheckSelectedGridView() As Boolean
        ...
        If Not rowCurr Is Nothing Then
            ...
            If rowCurr.Cells(FieldTenEn).Value.ToString() <> "" Then
...
#Region "Form Event"
    ...
    Private Sub cmdAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        End Try
    End Sub
    Private Sub cmdEdit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdEdit.Click, cmdAdd.Click
        Try
