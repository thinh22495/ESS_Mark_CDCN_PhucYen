...
Public Class frmESS_DMLoaiGiayTo
    Dim add As Boolean = False
    Dim edit As Boolean = False
    Dim loaded As Boolean = False
#Region "Khai bao Bien & Hang"
    Private Const Header As String = "LOẠI GIẤY TỜ"
    Private Const TableName As String = "STU_LoaiGiayTo"
    Private Const FieldID As String = "ID_giay_to"
    Private Const FieldMa As String = "Ma_giay_To"
    Private Const FieldTen As String = "Ten_giay_to"
    Private Const HeadMa As String = "Ký hiệu"
    Private Const HeadTen As String = "Tên giấy tờ"
