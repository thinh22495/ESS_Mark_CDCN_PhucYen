...
Public Class frmESS_DMChuyenNganh
    Dim add As Boolean = False
    Dim edit As Boolean = False
    Dim loaded As Boolean = False

#Region "Khai bao Bien & Hang"
    Private Const Header As String = "CHUYÊN NGÀNH ĐÀO TẠO"
    Private Const TableName As String = "STU_ChuyenNganh"
    Private Const TableParentName As String = "STU_Nganh"
    Private Const FieldID As String = "Id_chuyen_nganh"
    Private Const FieldMa As String = "Ma_chuyen_nganh"
    Private Const FieldTen As String = "Chuyen_nganh"
    Private Const FieldTenEn As String = "Chuyen_nganh_en"
    Private Const FieldParentID As String = "ID_nganh"
    Private Const HeadMa As String = "Mã chuyên ngành"
    Private Const HeadTen As String = "Tên chuyên ngành"
    Private Const HeadTenEn As String = "Tên tiếng anh"
    Private Const HeadParent As String = "Ngành đào tạo"
    ...
    Dim frmESS_Parrent As New frmESS_DMNganhDaoTao
...
#Region "User Functions"
    ...
    Private Function ValidForm() As Boolean
        ...
        If txtMa.Text.Length > 20 Then
            ...
            ValidForm = False
        End If
        If txtTen.Text.Length > 100 Then
