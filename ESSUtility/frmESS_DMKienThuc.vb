...
Public Class frmESS_DMKienThuc
    Dim add As Boolean = False
    Dim edit As Boolean = False
    Dim loaded As Boolean = False
#Region "Khai bao Bien & Hang"
    Private Const Header As String = "KHỐI KIẾN THỨC"
    Private Const TableName As String = "PLAN_ChuongTrinhDaoTaoKienThuc"
    Private Const FieldID As String = "ID_kien_thuc"
    Private Const FieldMa As String = "Ten_kien_thuc"
    Private Const HeadMa As String = "Khoi kien thuc"
...
#Region "User Functions"
    ...
    Private Function ValidForm() As Boolean
        ...
        If txtMa.Text = "" Then
            ...
            ValidForm = False
        End If
        If txtMa.Text.Length > 300 Then
            Me.ErrorProvider1.SetError(txtMa, "Không được nhập quá " & 300 & " ký tự!")
            txtMa.Focus()
            ValidForm = False
        End If
    End Function
