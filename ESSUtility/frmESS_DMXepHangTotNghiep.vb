...
Public Class frmESS_DMXepHangTotNghiep
    Dim add As Boolean = False
    Dim edit As Boolean = False
    Dim loaded As Boolean = False
#Region "Khai bao Bien & Hang"
    Private Const Header As String = "XẾP HẠNG TỐT NGHIỆP"
    Private Const TableName As String = "MARK_XepHangTotNghiep_TC_09"
...
#Region "User Functions"
    ...
    Private Function ValidForm() As Boolean
        ...
        If txtMa.Text.Length > 50 Then
            Me.ErrorProvider1.SetError(txtMa, "Không được nhập quá " & 20 & " ký tự!")
            txtMa.Focus()
            ValidForm = False
        End If
