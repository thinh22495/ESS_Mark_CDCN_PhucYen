...
Public Class frmESS_DMNhomDoiTuong
    Dim add As Boolean = False
    Dim edit As Boolean = False
    Dim loaded As Boolean = False
#Region "Khai bao Bien & Hang"
    Private Const Header As String = "NHÓM ĐỐI TƯỢNG"
    Private Const TableName As String = "STU_NhomDoiTuong"
    Private Const FieldID As String = "ID_nhom_dt"
    Private Const FieldMa As String = "Ma_nhom"
    Private Const FieldTen As String = "Ten_nhom"
    Private Const FieldTenEn As String = "Ten_nhom_en"
    Private Const HeadMa As String = "Ký hiệu"
    Private Const HeadTen As String = "Tên nhóm ĐT"
