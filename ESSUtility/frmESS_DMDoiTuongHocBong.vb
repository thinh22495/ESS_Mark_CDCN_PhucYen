...
Public Class frmESS_DMDoiTuongHocBong
    Dim add As Boolean = False
    Dim edit As Boolean = False
    Dim loaded As Boolean = False
#Region "Khai bao Bien & Hang"
    Private Const Header As String = "ĐỐI TƯỢNG TRỢ CẤP"
    Private Const TableName As String = "STU_DoiTuongHocBong"
    Private Const FieldID As String = "ID_dt_hb"
    Private Const FieldMa As String = "Ma_dt_hb"
    Private Const FieldTen As String = "Ten_dt_hb"
    Private Const FieldOther As String = "Sotien_trocap"
    Private Const HeadMa As String = "Ký hiệu"
    Private Const HeadTen As String = "Tên đối tượng"
    Private Const HeadOther As String = "Số tiền trợ cấp"
