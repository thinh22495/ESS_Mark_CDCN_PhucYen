...
Public Class frmESS_DMChucDanhSV
    Dim add As Boolean = False
    Dim edit As Boolean = False
    Dim loaded As Boolean = False
#Region "Khai bao Bien & Hang"
    Private Const Header As String = "CHỨC DANH SINH VIÊN"
    Private Const TableName As String = "STU_Chucdanh"
    Private Const FieldID As String = "ID_chuc_danh"
    Private Const FieldMa As String = "Chuc_danh"
    Private Const FieldTen As String = "Diem_thuong"
    Private Const HeadMa As String = "Tên chức danh"
...
#Region "User Functions"
    ...
    Private Function ValidForm() As Boolean
        ...
        If txtMa.Text.Length > 50 Then
            Me.ErrorProvider1.SetError(txtMa, "Mã quá dài, chỉ được nhập " & 50 & " ký tự!")
            txtMa.Focus()
            ValidForm = False
        End If
        If txtTen.Text.Length > 0 AndAlso Not IsNumeric(txtTen.Text) Then
            Me.ErrorProvider1.SetError(txtTen, "Điểm thưởng phải là số!")
            txtTen.Focus()
            ValidForm = False
        End If
    End Function
