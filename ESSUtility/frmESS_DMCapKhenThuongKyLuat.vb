...
Public Class frmESS_DMCapKhenThuongKyLuat
    Dim add As Boolean = False
    Dim edit As Boolean = False
    Dim loaded As Boolean = False
#Region "Khai bao Bien & Hang"
    Private Const Header As String = "CẤP KHEN THƯỞNG KỶ LUẬT"
    Private Const TableName As String = "STU_CapKhenThuongKyLuat"
    Private Const FieldID As String = "ID_cap"
    Private Const FieldMa As String = "Ten_cap"
    Private Const HeadMa As String = "Tên cấp"
...
#Region "Form Event"
    ...
    Private Sub cmdXoa_ESSClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdDelete.Click
        ...
        End Try
    End Sub
    Private Sub cmdSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdCancel.Click, cmdSave.Click
        Try
            ...
            If add Then
                ...
                If Not CheckExist(ValueMa) Then
                    cls.CatalogueInsert(TableName, FieldMa, ValueMa)
            ...
            ElseIf edit Then
                ...
                If ValueMa <> txtMa.Text Then
                    ...
                    If Not CheckExist(txtMa.Text) Then
                        Call GetValueFromUI()
                        cls.CatalogueUpdate(TableName, FieldID, ValueID, FieldMa, ValueMa)
