...
Public Class frmESS_DMKhoa
    Dim add As Boolean = False
    Dim edit As Boolean = False
    Dim loaded As Boolean = False
#Region "Khai bao Bien & Hang"
    Private Const Header As String = "KHOA ĐÀO TẠO"
    Private Const TableName As String = "STU_Khoa"
    Private Const FieldID As String = "ID_khoa"
    Private Const FieldMa As String = "Ma_khoa"
    Private Const FieldTen As String = "Ten_khoa"
    Private Const FieldTenEn As String = "Ten_khoa_en"
    Private Const HeadMa As String = "Mã khoa"
    Private Const HeadTen As String = "Tên khoa"
