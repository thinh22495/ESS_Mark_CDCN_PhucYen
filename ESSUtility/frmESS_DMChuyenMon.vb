...
Public Class frmESS_DMChuyenMon
    Dim add As Boolean = False
    Dim edit As Boolean = False
    Dim loaded As Boolean = False
#Region "Khai bao Bien & Hang"
    Private Const Header As String = "CHUYÊN MÔN"
    Private Const TableName As String = "PLAN_ChuyenMon"
    Private Const FieldID As String = "ID_chuyen_mon"
    Private Const FieldMa As String = "Ma_chuyen_mon"
    Private Const FieldTen As String = "Chuyen_mon"
    Private Const HeadMa As String = "Mã chuyên môn"
    Private Const HeadTen As String = "Tên chuyên môn"
