...
Public Class frmESS_NhomHocPhan
    Dim add As Boolean = False
    Dim edit As Boolean = False
    Dim loaded As Boolean = False
#Region "Khai bao Bien & Hang"
    Private objMonHoc_Bussines As New MonHoc_Bussines
    Private Const Header As String = "NHÓM HỌC PHẦN"
    Private Const TableName As String = "PLAN_MonHocNhomHocPhan"
    Private Const FieldID As String = "ID_nhom_hp"
    Private Const FieldMa As String = "Ma_nhom"
    Private Const FieldTen As String = "Ten_nhom"
    Private Const HeadMa As String = "Mã nhóm "
    Private Const HeadTen As String = "Tên nhóm học phần"
...
#Region "User Functions"
    ...
    Private Function CheckSelectedGridView() As Boolean
        ...
        If Not rowCurr Is Nothing Then
            ...
            dgvMonHoc.DataSource = objMonHoc_Bussines.DanhSachMonHoc_NhomHocPhan(ValueID)
            SetValueFromUI()
            Return True
        Else
...
#Region "Form Event"
    ...
    Private Sub cmdAdd_HP_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdAdd_HP.Click

    End Sub
  
    Private Sub cmdRemove_HP_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdRemove_HP.Click
