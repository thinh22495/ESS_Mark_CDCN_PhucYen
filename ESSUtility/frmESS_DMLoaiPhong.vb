...
Public Class frmESS_DMLoaiPhong
    Dim add As Boolean = False
    Dim edit As Boolean = False
    Dim loaded As Boolean = False
#Region "Khai bao Bien & Hang"
    Private Const Header As String = "LOẠI PHÒNG HỌC"
    ...
    Private Const FieldOther As String = "FieldOther"
    Private Const HeadMa As String = "Ký "
    Private Const HeadTen As String = "Tên "
    Private Const HeadOther As String = "Điểm "
