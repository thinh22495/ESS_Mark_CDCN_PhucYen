...
Public Class frmESS_DMTinh
    Dim add As Boolean = False
    Dim edit As Boolean = False
    Dim loaded As Boolean = False
#Region "Khai bao Bien & Hang"
    Private Const Header As String = "TỈNH THÀNH"
    Private Const TableName As String = "STU_Tinh"
    Private Const FieldID As String = "ID_tinh"
    Private Const FieldMa As String = "ID_tinh"
    Private Const FieldTen As String = "Ten_tinh"
    Private Const FieldTenEn As String = "Ten_tinh_en"
    Private Const HeadMa As String = "Ký hiệu"
    Private Const HeadTen As String = "Tên tỉnh"
...
#Region "User Functions"
    ...
    Private Function ValidForm() As Boolean
        ...
        If txtTenEn.Text.Length > 50 Then
            Me.ErrorProvider1.SetError(txtTenEn, "Không được nhập quá " & 50 & " ký tự!")
            txtTenEn.Focus()
            ValidForm = False
        End If
    End Function
