...
Public Class frmESS_DMXuLy
    Dim add As Boolean = False
    Dim edit As Boolean = False
    Dim loaded As Boolean = False

#Region "Khai bao Bien & Hang"
    Private Const Header As String = "MỨC XỬ LÝ"
    Private Const TableName As String = "STU_XuLy"
    Private Const TableParentName As String = "STU_CapKhenThuongKyLuat"
    Private Const FieldID As String = "ID_xu_ly"
    Private Const FieldMa As String = "Xu_ly"
    Private Const FieldTen As String = "So_thang"
    Private Const FieldOther As String = "Diem_phat"
    Private Const FieldParentID As String = "ID_cap"
    Private Const HeadMa As String = "Loại xử lý"
    Private Const HeadTen As String = "Số tháng"
    Private Const HeadOther As String = "Điểm phạt"
    Private Const HeadParent As String = "Cấp xử lý"
    Private Const MucXuLy As String = "Mức xử lý"
    Private Const FieldNameXuLy As String = "Muc_xu_ly"
    ...
    Dim valueMucXuLy As Integer = 0
    Dim frmESS_Parrent As New frmESS_DMCapKhenThuongKyLuat
...
#Region "User Functions"
    Private Sub FormatDataGridView()
        ...
        With col5
            .Name = FieldNameXuLy
            .DataPropertyName = FieldNameXuLy
            .HeaderText = MucXuLy
            .Width = 100
            .DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft
            .HeaderCell.Style.Alignment = DataGridViewContentAlignment.TopCenter
    ...
    Private Sub SetValueFromUI()
        ...
        cmbMucXuLy.SelectedIndex = valueMucXuLy - 1
    End Sub
    Private Sub GetValueFromUI()
        ...
        valueMucXuLy = cmbMucXuLy.SelectedValue
    End Sub
    Private Function ValidForm() As Boolean
        ...
        If txtMa.Text.Length > 50 Then
            ...
            ValidForm = False
        End If
        If txtTen.Text.Length > 0 AndAlso Not IsNumeric(txtTen.Text) Then
            Me.ErrorProvider1.SetError(txtTen, "Phải nhập số!")
            txtTen.Focus()
            ValidForm = False
        End If
    ...
    Private Function CheckSelectedGridView() As Boolean
        ...
        If Not rowCurr Is Nothing Then
            ...
            ValueOther = rowCurr.Cells(FieldOther).Value.ToString
            ValueParentID = CInt("0" & rowCurr.Cells(FieldParentID).Value.ToString)
            valueMucXuLy = CInt("0" & rowCurr.Cells(FieldNameXuLy).Value.ToString)
            SetValueFromUI()
            Return True
        Else
        ...
        Try
            ...
            If add Then
                ...
                If Not CheckExist(ValueMa) Then
                    cls.CatalogueInsert(TableName, FieldMa, ValueMa, FieldTen, ValueTen, FieldParentID, ValueParentID, FieldOther, ValueOther, FieldNameXuLy, cmbMucXuLy.SelectedIndex + 1)
                    ReloadDataGridView()
                    add = False
                End If
            ElseIf edit Then
                ...
                If ValueMa <> txtMa.Text Then
                    ...
                    If Not CheckExist(txtMa.Text) Then
                        Call GetValueFromUI()
                        cls.CatalogueUpdate(TableName, FieldID, ValueID, FieldMa, ValueMa, FieldTen, ValueTen, FieldParentID, ValueParentID, FieldOther, ValueOther, FieldNameXuLy, cmbMucXuLy.SelectedIndex + 1)
                        ReloadDataGridView()
                        edit = False
                    End If
                Else
