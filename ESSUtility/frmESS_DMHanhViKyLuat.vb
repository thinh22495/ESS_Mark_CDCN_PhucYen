...
Public Class frmESS_DMHanhViKyLuat
    Dim add As Boolean = False
    Dim edit As Boolean = False
    Dim loaded As Boolean = False
#Region "Khai bao Bien & Hang"
    Private Const Header As String = "HÀNH VI KỶ LUẬT"
    Private Const TableName As String = "STU_HanhVi"
    Private Const FieldID As String = "ID_hanh_vi"
    Private Const FieldMa As String = "Ma_hanh_vi"
    Private Const FieldTen As String = "Hanh_vi"
    Private Const HeadMa As String = "Mã hành vi"
    Private Const HeadTen As String = "Tên hành vi"
