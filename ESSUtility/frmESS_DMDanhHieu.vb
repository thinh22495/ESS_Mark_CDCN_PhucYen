...
Public Class frmESS_DMDanhHieu
    Dim add As Boolean = False
    Dim edit As Boolean = False
    Dim loaded As Boolean = False
#Region "Khai bao Bien & Hang"
    Private Const Header As String = "DANH HIỆU THI ĐUA"
    Private Const TableName As String = "STU_DanhHieu"
    Private Const FieldID As String = "ID_danh_hieu"
    Private Const FieldMa As String = "Danh_hieu"
    Private Const FieldMaEn As String = "Danh_hieu_en"
    Private Const FieldTuDiem As String = "Tu_diem"
    Private Const FieldDenDiem As String = "Den_diem"
    Private Const HeadMa As String = "Danh hiệu"
    Private Const HeadMaEn As String = "Tên tiếng anh"
    Private Const HeadTuDiem As String = "Từ diểm"
...
#Region "User Functions"
    ...
    Private Sub ShowCaption()
        ...
        Me.LabelTen.Text = HeadTuDiem
        Me.LabelOther.Text = HeadDenDiem
    End Sub
#End Region
#Region "Form Event"
