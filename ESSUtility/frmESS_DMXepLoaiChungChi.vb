...
Public Class frmESS_DMXepLoaiChungChi
    Dim add As Boolean = False
    Dim edit As Boolean = False
    Dim loaded As Boolean = False
#Region "Khai bao Bien & Hang"
    Private Const Header As String = "XẾP LOẠI CHỨNG CHỈ"
    Private Const TableName As String = "MARK_XepLoaiChungChi_TC_09"
...
#Region "User Functions"
    ...
    Private Function ValidForm() As Boolean
        ...
        End If
    End Function
    Private Sub VisibleCmd(ByVal status As Double)
            ...
            ElseIf edit Then
                ...
                If ValueMa <> txtMa.Text Then
                    ...
                    If Not CheckExist(txtMa.Text) Then
                        Call GetValueFromUI()
                        cls.CatalogueUpdate(TableName, FieldID, ValueID, FieldMa, FieldMaEn, ValueMaEn, ValueMa, FieldTuDiem, ValueTuDiem, FieldDenDiem, ValueDenDiem)
                        ReloadDataGridView()
                        edit = False
                    End If
                Else
