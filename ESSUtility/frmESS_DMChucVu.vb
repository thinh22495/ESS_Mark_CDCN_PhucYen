...
Public Class frmESS_DMChucVu
    Dim add As Boolean = False
    Dim edit As Boolean = False
    Dim loaded As Boolean = False
#Region "Khai bao Bien & Hang"
    Private Const Header As String = "CHỨC VỤ CÁN BỘ"
    Private Const TableName As String = "PLAN_ChucVu"
    Private Const FieldID As String = "ID_chuc_vu"
    Private Const FieldMa As String = "Ma_chuc_vu"
    Private Const FieldTen As String = "Chuc_vu"
    Private Const HeadMa As String = "Mã chức vụ"
    Private Const HeadTen As String = "Tên chức vụ"
