...
Public Class frmESS_DMLoaiChungChi
    Dim add As Boolean = False
    Dim edit As Boolean = False
    Dim loaded As Boolean = False
#Region "Khai bao Bien & Hang"
    Private Const Header As String = "LOẠI CHỨNG CHỈ"
    Private Const TableName As String = "MARK_LoaiChungChi_TC"
    Private Const FieldID As String = "ID_chung_chi"
    Private Const FieldMa As String = "Ky_hieu"
    Private Const FieldTen As String = "Loai_chung_chi"
    Private Const HeadMa As String = "Ký hiệu"
    Private Const HeadTen As String = "Tên chứng chỉ"
