...
Public Class frmESS_DMToaNha_KTX
    Dim add As Boolean = False
    Dim edit As Boolean = False
    Dim loaded As Boolean = False

#Region "Khai bao Bien & Hang"
    Private Const Header As String = "TÒA NHÀ KÝ TÚC XÁ"
    Private Const TableName As String = "STU_ToaNhaKyTucXa"
    Private Const TableParentName As String = "PLAN_CoSoDaoTao"
    Private Const FieldID As String = "ID_nha_ktx"
    Private Const FieldMa As String = "Ma_nha"
    Private Const FieldTen As String = "Ten_nha"
    Private Const FieldParentID As String = "ID_co_so"
    Private Const HeadMa As String = "Mã nhà"
    Private Const HeadTen As String = "Tên nhà"
    Private Const HeadParent As String = "Cơ Sở"
