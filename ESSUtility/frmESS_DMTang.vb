...
Public Class frmESS_DMTang
    Dim add As Boolean = False
    Dim edit As Boolean = False
    Dim loaded As Boolean = False
#Region "Khai bao Bien & Hang"
    Private Const Header As String = "TẦNG NHÀ"
    Private Const TableName As String = "PLAN_Tang"
    Private Const FieldID As String = "ID_tang"
    Private Const FieldMa As String = "Ma_tang"
    Private Const FieldTen As String = "Ten_tang"
    Private Const HeadMa As String = "Mã tầng"
    Private Const HeadTen As String = "Tên tầng"
