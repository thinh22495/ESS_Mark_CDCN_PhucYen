...
Public Class frmESS_DMDoiTuong
    Dim add As Boolean = False
    Dim edit As Boolean = False
    Dim loaded As Boolean = False
#Region "Khai bao Bien & Hang"
    Private Const Header As String = "ĐỐI TƯỢNG TUYỂN SINH"
    Private Const TableName As String = "STU_DoiTuong"
    Private Const FieldID As String = "ID_dt"
    Private Const FieldMa As String = "Ma_dt"
    Private Const FieldTen As String = "Ten_dt"
    Private Const FieldOther As String = "Phan_tram_mien_giam"
    Private Const HeadMa As String = "Ký hiệu"
    Private Const HeadTen As String = "Tên đối tượng"
    Private Const HeadOther As String = "Miễn giảm (%)"
