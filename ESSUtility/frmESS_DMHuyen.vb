...
Public Class frmESS_DMHuyen
    Dim add As Boolean = False
    Dim edit As Boolean = False
    Dim loaded As Boolean = False

#Region "Khai bao Bien & Hang"
    Private Const Header As String = "HUYỆN"
    Private Const TableName As String = "STU_Huyen"
    Private Const TableParentName As String = "STU_Tinh"
    Private Const FieldID As String = "ID_huyen"
    Private Const FieldMa As String = "ID_huyen"
    Private Const FieldTen As String = "Ten_huyen"
    Private Const FieldTenEn As String = "Ten_huyen_en"
    Private Const FieldParentID As String = "ID_tinh"
    Private Const HeadMa As String = "Ký hiệu huyện"
    Private Const HeadTen As String = "Tên huyện huyện"
    Private Const HeadTenEn As String = "Tên tiếng anh"
    Private Const HeadParent As String = "Tên Tỉnh"
    ...
    Dim ValueParentID As String = ""
    Dim frmESS_Parrent As New frmESS_DMTinh
...
#Region "User Functions"
    ...
    Private Function ValidForm() As Boolean
        ...
        If txtTen.Text.Length > 200 Then
            Me.ErrorProvider1.SetError(txtTen, "Không được nhập quá " & 30 & " ký tự!")
            txtTen.Focus()
            ValidForm = False
        End If
        If txtTenEn.Text.Length > 200 Then
    ...
    Private Function CheckSelectedGridView() As Boolean
        ...
        If Not rowCurr Is Nothing Then
            ...
            ValueParentID = rowCurr.Cells(FieldParentID).Value.ToString
            SetValueFromUI()
            Return True
        Else
