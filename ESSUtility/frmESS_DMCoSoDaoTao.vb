...
Public Class frmESS_DMCoSoDaoTao
    Dim add As Boolean = False
    Dim edit As Boolean = False
    Dim loaded As Boolean = False
#Region "Khai bao Bien & Hang"
    Private Const Header As String = "CƠ SỞ ĐÀO TẠO"
    Private Const TableName As String = "PLAN_CoSoDaoTao"
    Private Const FieldID As String = "ID_co_so"
    Private Const FieldMa As String = "Ma_co_so"
    Private Const FieldTen As String = "Ten_co_so"
    Private Const HeadMa As String = "Mã cơ sở"
    Private Const HeadTen As String = "Tên cơ sở"
...
#Region "Form Event"
    ...
    Private Sub cmdXoa_ESSClick(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        End Try
    End Sub
    Private Sub cmdSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSave.Click, cmdDelete.Click
        Try
