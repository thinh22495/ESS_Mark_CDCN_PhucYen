...
Public Class frmESS_DMDanToc
    Dim add As Boolean = False
    Dim edit As Boolean = False
    Dim loaded As Boolean = False
#Region "Khai bao Bien & Hang"
    Private Const Header As String = "DÂN TỘC"
    Private Const TableName As String = "STU_DanToc"
    Private Const FieldID As String = "ID_dan_toc"
    Private Const FieldMa As String = "Ma_dan_toc"
    Private Const FieldTen As String = "Dan_toc"
    Private Const FieldTenEn As String = "Dan_toc_en"
    Private Const HeadMa As String = "Mã dân tộc"
    Private Const HeadTen As String = "Tên dân tộc"
    Private Const HeadTenEn As String = "Tên tiếng anh"
...
#Region "User Functions"
    ...
    Private Function ValidForm() As Boolean
        ...
        If txtTen.Text.Length > 50 Then
            ...
            ValidForm = False
        End If
        If txtTenEn.Text.Length > 50 Then
            Me.ErrorProvider1.SetError(txtTenEn, "Tên quá dài, chỉ được nhập " & 50 & " ký tự!")
            txtTenEn.Focus()
            ValidForm = False
        End If
    End Function
